...
from config import log_json_file
from monitor import formatar_metricas, metricas
from helpers import log_verbose, enviar_email_alerta, timestamp  # agora vem de helpers
...
def gerar_log(tipo, componente, valor_antigo, valor_novo, mensagem):
    dados = {
        "tipo": tipo,
        "componente": componente,
        "valor_antigo": valor_antigo,
    ...
    caminho_arquivo = os.path.join(PASTA_LOGS, "monitoramento.log")
